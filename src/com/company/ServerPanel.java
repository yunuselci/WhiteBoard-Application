    ...
    public void paint(Graphics g) {
        ...
        if (ServerBoard.draw_type.equals("Square")) {
            ...
            for (int i = 0; i < ServerBoard.square.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.square.get(i).counter);
                if(ServerBoard.square.get(i).counter >= 1){
                    ServerBoard.writeShapeCounter(1);
            ...
            for (int i = 0; i < ServerBoard.FSquare.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.FSquare.get(i).counter);
                if(ServerBoard.FSquare.get(i).counter >= 1){
                    ServerBoard.writeShapeCounter(1);
            ...
            for (int i = 0; i < ServerBoard.circle.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.circle.get(i).counter);
                if(ServerBoard.circle.get(i).counter >= 1){
                    ServerBoard.writeShapeCounter(1);
            ...
            for (int i = 0; i < ServerBoard.FCircle.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.FCircle.get(i).counter);
                if(ServerBoard.FCircle.get(i).counter >= 1){
                    ServerBoard.writeShapeCounter(1);
            ...
            for (int i = 0; i < ServerBoard.squares.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.squares.get(i).counter);
            ...
            for (int i = 0; i < ServerBoard.circles.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.circles.get(i).counter);
            ...
            for (int i = 0; i <ServerBoard.line.size(); i++) {
                ...
                ServerBoard.writeShapeCounter(ServerBoard.line.get(i).counter);
